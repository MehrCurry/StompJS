...
var _2d3=_2cd();
var _2d4=_2d3+"Loader.swf?.kv=10.05";
...
if(_2d5!="flash"||!_2d8([9,0,115])){
_2d9();
}else{
_2cc=setTimeout(_2d9,_2c9);
_2da();
}
};
...
var _2e0=swf.GetVariable("$version");
var _2e1=_2e0.split(" ")[1].split(",");
_2de=[];
for(var i=0;i<_2e1.length;i++){
_2de[i]=parseInt(_2e1[i]);
}
}
catch(e){
ie=false;
...
var _2e0=navigator.plugins["Shockwave Flash"].description;
_2e0=_2e0.replace(/\s*r/g,".");
var _2e1=_2e0.split(" ")[2].split(".");
_2de=[];
for(var i=0;i<_2e1.length;i++){
_2de[i]=parseInt(_2e1[i]);
}
...
var _2e3=navigator.userAgent;
if(_2de!==null&&_2de[0]===10&&_2de[1]===0&&_2e3.indexOf("Windows NT 6.0")!==-1){
_2de=null;
}
return _2de;
};
var _2d8=function(_2e4){
var _2e5=_2dd();
if(_2e5==null){
return false;
}
for(var i=0;i<Math.max(_2e5.length,_2e4.length);i++){
var _2e7=_2e5[i]-_2e4[i];
if(_2e7!=0){
return (_2e7>0)?true:false;
}
}
return true;
};
...
elt.outerHTML="<object classid=\"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000\" height=\"0\" width=\"0\" id=\""+ID+"\"><param name=\"movie\" value=\""+_2d4+"\"></param></object>";
...
elt.setAttribute("data",_2d4);
document.body.appendChild(elt);
self.elt=elt;
}
};
self.attachToOnload=function(_2e9){
if(window.addEventListener){
window.addEventListener("load",_2e9,true);
}else{
if(window.attachEvent){
window.attachEvent("onload",_2e9);
}else{
onload=_2e9;
}
}
...
var _2ea={};
(function(){
var _2eb={8364:128,129:129,8218:130,402:131,8222:132,8230:133,8224:134,8225:135,710:136,8240:137,352:138,8249:139,338:140,141:141,381:142,143:143,144:144,8216:145,8217:146,8220:147,8221:148,8226:149,8211:150,8212:151,732:152,8482:153,353:154,8250:155,339:156,157:157,382:158,376:159};
var _2ec={128:8364,129:129,130:8218,131:402,132:8222,133:8230,134:8224,135:8225,136:710,137:8240,138:352,139:8249,140:338,141:141,142:381,143:143,144:144,145:8216,146:8217,147:8220,148:8221,149:8226,150:8211,151:8212,152:732,153:8482,154:353,155:8250,156:339,157:157,158:382,159:376};
_2ea.toCharCode=function(n){
...
_2ea.fromCharCode=function(code){
...
var _2f1=String.fromCharCode(127);
var NULL=String.fromCharCode(0);
var _2f3="\n";
var _2f4=function(s){
var a=[];
for(var i=0;i<s.length;i++){
var code=_2ea.fromCharCode(s.charCodeAt(i));
if(code==127){
i++;
if(i==s.length){
a.hasRemainder=true;
...
var _2f9=_2ea.fromCharCode(s.charCodeAt(i));
switch(_2f9){
case 127:
a.push(127);
break;
...
var _2fa=function(buf){
var a=[];
while(buf.remaining()){
var n=buf.getUnsigned();
var chr=String.fromCharCode(_2ea.toCharCode(n));
switch(chr){
case _2f1:
a.push(_2f1);
a.push(_2f1);
...
_2ea.toArray=function(s,_300){
if(_300){
return _2f4(s);
}else{
var a=[];
for(var i=0;i<s.length;i++){
a.push(_2ea.fromCharCode(s.charCodeAt(i)));
}
return a;
}
};
_2ea.toByteString=function(buf,_304){
if(_304){
return _2fa(buf);
}else{
var a=[];
while(buf.remaining()){
var n=buf.getUnsigned();
a.push(String.fromCharCode(_2ea.toCharCode(n)));
}
return a.join("");
}
};
...
if(_309.indexOf(".kv="==-1)){
_309+=((_309.indexOf("?")==-1)?"?":"&")+".kv=10.05";
}else{
_309=_309.replace(/\.kv=[^&]*(.*)/,".kv=10.05$1");
}
var _30a=new URI(_309);
var _30b={"http":80,"https":443};
if(_30a.port==null){
_30a.port=_30b[_30a.scheme];
_30a.authority=_30a.host+":"+_30a.port;
}
this.origin=_30a.scheme+"://"+_30a.authority;
this.location=_309;
this.xhr=null;
...
var _312=3000;
_25a.readyState=0;
function connect(_313){
if(_313.reconnectTimer!==null){
_313.reconnectTimer=null;
}
_313.buf=new ByteBuffer();
var _314=new URI(_313.location);
var _315=[];
if(_313.location.indexOf("&.kb=")===-1&&_313.location.indexOf("?.kb=")===-1){
_315.push(".kb=512");
}
switch(browser){
case "ie":
...
case "firefox":
_315.push(".kp=1025");
_315.push(String(Math.random()).substring(2));
break;
case "android":
_315.push(".kp=4096");
_315.push(".kbp=4096");
...
_315.push(".kc=text/plain;charset=windows-1252");
if(_315.length>0){
if(_314.query===undefined){
_314.query=_315.join("&");
}else{
_314.query+="&"+_315.join("&");
}
}
var xhr=_313.xhr=new XMLHttpRequest0();
var _317={"xhr":xhr,"position":0};
_313.nextMessageAt=0;
if(_313.location.indexOf(".ki=p")==-1||_313.location.indexOf("https://")==0){
...
xhr.onload=function(){
_process(_313,_317);
if(_313.xhr==_317.xhr&&_313.readyState!=2){
_313.xhr.onerror=function(){
};
_313.xhr.ontimeout=function(){
};
_313.xhr.onreadystatechange=function(){
};
if(_313.reconnectImmediately){
_313.reconnectImmediately=false;
connect(_313);
}else{
doError(_313);
}
...
if(!_313.reconnectImmediately&&xhr.readyStateChange>3){
_313.readyState=1;
doOpen(_313);
xhr.onreadystatechange=function(){
};
...
xhr.open("GET",_314.toString(),true);
xhr.send("");
if(_313.location.indexOf("&.ki=p")==-1){
setTimeout(function(){
if(xhr.readyState<3&&_313.readyState<2){
_313.location+="&.ki=p";
connect(_313);
}
},_312);
...
function _disconnect(_318){
if(_318.reconnectTimer!==null){
clearTimeout(_318.reconnectTimer);
_318.reconnectTimer=null;
}
if(_318.xhr!==null){
_318.xhr.onprogress=function(){
};
_318.xhr.onload=function(){
};
_318.xhr.onerror=function(){
};
_318.xhr.abort();
}
_318.lineQueue=[];
_318.lastEventId=null;
_318.location=null;
_318.readyState=2;
};
function _process(_319,_31a){
var _31b=_31a.xhr.responseText;
var _31c=_31b.slice(_31a.position);
_31a.position=_31b.length;
var buf=_319.buf;
var _31e=_2ea.toArray(_31c,_319.requiresEscaping);
if(_31e.hasRemainder){
_31a.position--;
}
buf.position=buf.limit;
buf.putBytes(_31e);
buf.position=_319.nextMessageAt;
buf.mark();
parse:
while(true){
if(!buf.hasRemaining()){
...
switch(type&128){
case _30d:
var _320=buf.indexOf(_30e);
if(_320==-1){
break parse;
}
var _321=buf.array.slice(buf.position,_320);
var data=new ByteBuffer(_321);
var _323=_320-buf.position;
buf.skip(_323+1);
buf.mark();
if(type==_30f){
handleCommandFrame(_319,data);
}else{
dispatchText(_319,data);
}
break;
case _310:
var _324=0;
...
if(buf.remaining()<_324){
break parse;
}
var _327=buf.array.slice(buf.position,buf.position+_324);
var _328=new ByteBuffer(_327);
buf.skip(_324);
buf.mark();
dispatchBytes(_319,_328);
break;
default:
...
function handleCommandFrame(_329,data){
while(data.remaining()){
var _32b=String.fromCharCode(data.getUnsigned());
switch(_32b){
case "0":
break;
case "1":
_329.reconnectImmediately=true;
break;
default:
throw new Error("Protocol decode error. Unknown command: "+_32b);
}
}
};
function dispatchBytes(_32c,buf){
var e=document.createEvent("Events");
e.initEvent("message",true,true);
e.lastEventId=_32c.lastEventId;
e.data=_24f(buf);
e.decoder=_240;
e.origin=_32c.origin;
if(e.source!==null){
e.source=null;
}
if(typeof (_32c.onmessage)==="function"){
_32c.onmessage(e);
}
};
...
function doOpen(_331){
if(typeof (_331.onopen)==="function"){
_331.onopen();
}
};
function doClose(_332){
if(_332.readyState!=2){
_332.disconnect();
doError(_332);
}
};
function doError(_333){
var e=document.createEvent("Events");
e.initEvent("error",true,true);
if(typeof (_333.onerror)==="function"){
_333.onerror(e);
}
};
return _308;
...
this.URL=_337;
if(_337.indexOf(".kv=")==-1){
_337+=((_337.indexOf("?")==-1)?"?":"&")+".kv=10.05";
}else{
_337=_337.replace(/\.kv=[^&]*(.*)/,".kv=10.05$1");
}
if(browser=="opera"||browser=="ie"){
this.requiresEscaping=true;
}
...
var _33d=255;
var _33e=1;
var _33f=[_33e,48,49,_33d];
var _340=[_33e,48,50,_33d];
...
switch(this.readyState){
case 1:
doSend(this,new ByteBuffer(_340));
_344(this);
break;
}
};
function doSend(_345,buf){
_345.bufferedAmount+=buf.remaining();
_345._sendQueue.push(buf);
if(!_345._writeSuspended){
doFlush(_345);
}
};
function doFlush(_347){
var _348=_347._sendQueue;
var _349=_348.length;
_347._writeSuspended=(_349>0);
if(_349>0){
var xhr=new XMLHttpRequest0();
xhr.open("POST",_347._upstream,true);
xhr.onreadystatechange=function(){
if(xhr.readyState==4){
switch(xhr.status){
case 200:
...
xhr.send(_24f(out,_347.requiresEscaping));
}
}
_347.bufferedAmount=0;
};
var _339=function(_34c){
var url=new URI(_34c.URL);
url.scheme=url.scheme.replace("ws","http");
var _34e=_34c.requiresEscaping?"/;e/cte":"/;e/ct";
url.path=url.path.replace(/[\/]?$/,_34e);
var _34f=url.toString();
var _350=_34f.indexOf("?");
if(_350==-1){
_34f+="?";
}else{
_34f+="&";
}
_34f+=".kn="+String(Math.random()).substring(2);
if(browser=="android"||browser.ios){
_34f+="&.kkt=30";
}
var _351=new XMLHttpRequest0();
var _352=false;
_351.open("GET",_34f,true);
_351.onreadystatechange=function(){
switch(_351.readyState){
case 2:
...
case 4:
_352=true;
if(_34c.readyState<2){
if(_351.status==201){
var _354=_351.responseText.split("\n");
_34c._upstream=_354[0];
var _355=_354[1];
_34c._downstream=new _307(_355);
_356(_34c,_34c._downstream);
_357(_34c);
}else{
_353(_34c);
}
...
var _356=function(_358,_359){
_359.onmessage=function(_35a){
switch(_35a.type){
case "message":
if(_358.readyState==1){
_358.onmessage(_35a);
}
break;
}
};
_359.onerror=function(){
_359.disconnect();
_344(_358);
};
};
var _343=function(buf,_35c){
var _35d=0;
var _35e=0;
do{
_35e<<=8;
...
var _357=function(_360){
_360.readyState=1;
_360.onopen();
};
var _353=function(_361){
if(_361.readyState<2){
_361.readyState=2;
_361.onerror();
}
};
var _344=function(_362){
switch(_362.readyState){
case 0:
case 2:
break;
case 1:
...
(function(){
var _363="javascript:ws";
var _364="javascript:wss";
var _365="javascript:wse";
var _366="javascript:wse+ssl";
var _367="flash:wse";
var _368="flash:wse+ssl";
var _369="flash:wsr";
var _36a="flash:wsr+ssl";
var _36b={};
_36b[_363]=_256;
_36b[_364]=_256;
_36b[_365]=_335;
...
_36b[_369]=_28a;
_36b[_36a]=_28a;
window.WebSocket=function(url,_36d){
var _36e=new URI(url);
if(_36e.port===undefined){
var _36f=_36e.scheme;
_36e.port=((_36f.indexOf("wss")==-1)&&(_36f.indexOf("ssl")==-1))?80:443;
}
url=_36e.toString();
this.URL=_36e.toString();
this.readyState=0;
this._subprotocol=_36d;
var _370=splitScheme(url);
var _371=_370.shift();
this._urlRemainder=_370.shift();
if(_371=="ws"||_371=="wse"||_371=="wss"||_371=="wse+ssl"){
var _372=_22d("kaazing:WebSocketConnectionStrategies");
var _373=null;
if(_372){
_373=_372.split(" ");
}
if(!_373){
if(_371=="ws"){
this._connectionStrategies=_236(WebSocket.connectionStrategies,function(_374){
return !(_374.match("wss")||_374.match("ssl"));
});
}else{
if(_371=="wss"){
...
this._connectionStrategies=_236(WebSocket.connectionStrategies,_376);
}
}
}
}
...
if(_36b[_371]){
this._connectionStrategies=[_371];
}else{
throw new Error("Unsupported composite scheme: "+_371);
}
}
...
case "android":
case "opera":
return [_363,_365,_364,_366];
case "ie":
var _378=navigator.appVersion;
if(_378.indexOf("MSIE 6.0")>=0||_378.indexOf("MSIE 7.0")>=0){
return [_363,_367,_365,_364,_368,_366];
}else{
return [_363,_365,_367,_364,_366,_368];
}
case "firefox":
case "chrome":
case "safari":
...
window.WebSocket.__impls__=_36b;
